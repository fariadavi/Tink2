...
public class TelaRanking extends JFrame {
	...
	private static final String RANKING_PATTERN = "%d - %s    %d";
	...
	public void setPosicoesRanking(int posicao, String nome, int pontuacao) {
		String rankText = String.format(RANKING_PATTERN, posicao+1, nome, pontuacao);
		this.posicoesRanking[posicao].getBotaoOpcao().setText(rankText);
	}
}
